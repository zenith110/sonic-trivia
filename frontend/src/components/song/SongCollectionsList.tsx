...
interface SongCollectionsListProps {
...
export function SongCollectionsList({
  collections,
  onCreateClick,
  onEditClick,
  onDeleteClick,
  ...
  onPreviousPage,
  onNextPage,
}: SongCollectionsListProps) {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">Song Collections</h2>
          <p className="text-sm text-muted-foreground">
            Manage your song collections for Guess That Song
            {totalCollections > 0 && (
      ...
      {isLoading ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-sm text-muted-foreground">
              Please wait while we fetch your song collections
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-lg font-semibold mb-2">
              {totalCollections > 0
                ...
                : "No song collections yet"}
            </h3>
            <p className="text-sm text-muted-foreground mb-4">
              {totalCollections > 0
                ? "Try navigating to a different page"
                : "Create your first song collection to get started"}
            </p>
